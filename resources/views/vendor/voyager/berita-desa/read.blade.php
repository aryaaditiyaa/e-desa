...
@section('content')
    <div class="page-content read container-fluid">
        ...
        <div class="panel panel-bordered" style="padding: 1rem;">
            <div class="row">
                <div class="col-md-12">
                    <h4>Komentar</h4>
                </div>
            ...
            <div class="row">
                <?php
                $comments = \App\Models\Komentar::where([
                    ['slug', 'berita-desa'],
                    ['berita_desa_id', $dataTypeContent->getKey()]
                ])->get()
                ?>
                @foreach($comments as $comment)
                    <div class="col-md-12">
                        <div class="media">
                            <a>
                                <img src="{{ asset('storage/' . $comment->penduduk->avatar) }}"
                                     class="rounded-circle profile-comment"
                                     style="margin-right: 12px; align-self: center!important; width: 64px">
                            </a>
                            <div class="media-body">
                                <div class="media-body">
                                    <h5 class="mt-0">{{ $comment->penduduk->nama_lengkap }} - <span
                                            class="small">{{ Carbon\Carbon::parse($comment->created_at)->isoFormat('dddd, D MMMM Y, h:mm') }}</span>
                                    </h5>
                                    {{ $comment->komentar }}
                                </div>
                            </div>
